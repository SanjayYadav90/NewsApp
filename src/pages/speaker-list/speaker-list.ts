...
import { Component } from '@angular/core';
import {PoemService} from '../../providers/poem-service';
...
export class SpeakerListPage {
  ...
  constructor( public navCtrl: NavController, public peopleService: PoemService){
    this.loadPeople();
  }
  ...
  loadPeople(){
    ...
    // .then(data => {
    //   this.people = data;
    //   console.log("jitendra"+this.people);
    // });
  }
}
